...
<img width ="70%" alt="To reflect like me is to be like me. But you are you, not a reflection of yourself. To understand my essence, you must listen first and speak last. Your test has already begun." src="../images/ducky-talk-reflect.png" />
...
```mermaid
%%{init: {'theme': 'base', 'themeVariables': {'mainBkg': '#ffffff', 'nodeTextColor': '#000000', 'nodeBorder': '#000000', 'lineColor': '#32CD32'}}}%%
graph LR
