# Merge of Legends: Conference Booth Abstract

## Game Overview

**Merge of Legends** is an interactive, narrative-driven GitHub Skills experience designed for conference booth demonstrations. Players embark on a quest to save the magical land of Codia by restoring the corrupted Mainline through version control mastery.
...
The game leverages GitHub's native features to create an immersive, hands-on learning experience:
- Players interact through GitHub Issues with automated workflows
- Real-time validation and feedback guide participants through challenges
...
Built entirely on GitHub's platform using:
